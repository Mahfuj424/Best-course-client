...
const Footer = () => {
    return (
        <footer className=" bg-[#140342]">
            <div className="footer p-10 bg-[#140342] text-white">
                <div>
                    <PiGraduationCap className='h-14 w-14 text-[#00FF84]' />
                    <p className='text-lg'>Best Courses<br /> ACME Industries Ltd.<br />Providing reliable tech since 1992</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className="form-control w-52">
                        ...
                        <div className="relative">
                            ...
                            <button className="btn fill-btn absolute text-xs top-0 right-0 rounded-l-none">Subscribe</button>
                        </div>
                    </div>
            ...
            <p className='p-4 text-white text-center'><span>©Copyright 2023 Alright</span></p>
        </footer>
    );
};
